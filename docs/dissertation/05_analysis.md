...
improved PR-AUC by, say, 0.03 — a large effect by the standards of the tabular credit literature
— that improvement could not be *demonstrated* here, because the fold band spans roughly 0.19.
...
operating point, not separating two models' full score distributions. The general principle —
**at extreme sample sizes, decision-theoretic improvements, which reuse the ranking, remain
